...
<html>
	...
	<body style="background:linear-gradient(white,#ebebeb,white);">
		...
		<div class="container">
			<hr />
			<form class="form-horizontal text-center" action="<%=ctx%>/xydj/query.action?" method="post">
				<div class="container ">
		...
		<div class="container ">
			<table class="table table-hover table-striped  text-center" >
				<caption class="text-center"><strong>信誉等级信息</strong></caption>
				<thead >
					<tr class="bg-primary">
						<td>序号</td>
				...
				<c:forEach items="${list }" var="xydj" varStatus="i">
					<tr>
						...
						<td>${xydj.cxyName}</td>
						<td>
							<a href="javascript:editpage('${xydj.cxyId }')">修改</a>&nbsp;&nbsp;
						</td>
					</tr>
					</c:forEach>
				</tbody>
