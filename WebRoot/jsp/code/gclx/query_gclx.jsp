...
<html>
	...
	<body style="background:linear-gradient(white,#ebebeb,white);">
		...
		<div class="container">
			<hr />
			<form class="form-horizontal text-center" action="<%=ctx%>/gclx/query.action?" method="post">
				<div class="container ">
		...
		<div class="container ">
			<table class="table table-hover table-striped  text-center" >
				<caption class="text-center"><strong>工程类型信息</strong></caption>
				<thead >
					<tr class="bg-primary">
						<td>序号</td>
				...
				<c:forEach items="${list }" var="gclx" varStatus="i">
					<tr>
						...
						<td>${gclx.cglName}</td>
						<td>
							<a href="javascript:editpage('${gclx.cglId }')">修改</a>&nbsp;&nbsp;
						</td>
					</tr>
					</c:forEach>
				</tbody>
